      ...
      <div className="GettingStarted">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Your own Bitcoin Cash blockchain to configure however you choose. This blockchain is created from scratch each time you start BITBOX. It doesn&rsquo;e connect to the real network and only consists of transactions and blocks which you create locally so it&rsquo;s quick and responsive. Execute commands from the command line and client/server.</p>

            <h3>Visual Mnemonic & HD Path</h3>
