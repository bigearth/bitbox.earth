      ...
      <div className="docs">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Download the <a href='https://github.com/bigearth/bitbox-electron/releases/download/0.0.5/BITBOX-0.0.5.dmg'>app for MacOS</a>.</p>
            <p>You can verify the files haven&rsquo;t been tampered w/ by downloading them and running <code>openssl sha -sha256 path/to/BITBOX.major.minor.path.dmg</code>. Verify the output matches the latest BITBOX release&rsquo;s <a href='https://github.com/bigearth/keys-n-hashes'>checksum</a>.</p>
