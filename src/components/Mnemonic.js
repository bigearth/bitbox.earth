...
class Mnemonic extends Component {
  componentDidMount() {
    document.title = "Mnemonic - BITBOX by EARTH - Supercharge your Bitcoin Cash workflow";
  }
  ...
  render() {
      ...
      <div className="Mnemonic">
        ...
        <div className="pure-menu pure-menu-horizontal breadcrumb">
          <ul className="pure-menu-list">
            ...
            <li className="pure-menu-item"> > </li>
            <li className="pure-menu-item"><Link className="pure-menu-link" to="/bitboxcli/mnemonic">Mnemonic</Link></li>
          </ul>
        </div>
    ...
    BITBOX.Mnemonic.mnemonicToSeedHex('vendor talk alone sick balance tissue number armor frequent plug transfer chest', 'password');
    ...
    BITBOX.Mnemonic.mnemonicToSeedHex('idea relax weird defense body bronze champion ancient vocal peanut similar dose grit company peasant gate sunset deal library act include penalty annual main', '');
    ...
    BITBOX.Mnemonic.mnemonicToSeedHex('bus aware census desk orphan zebra fashion host try muscle pig close jealous slice elegant prison reject ship great program trumpet syrup tray remove', '');
    ...
    BITBOX.Mnemonic.mnemonicToSeedHex('frost deliver coin clutch upon round scene wonder various wise luggage country', 'yayayayay');
    ...
    BITBOX.Mnemonic.mnemonicToSeedBuffer('vendor talk alone sick balance tissue number armor frequent plug transfer chest', 'password');
    ...
    BITBOX.Mnemonic.mnemonicToSeedBuffer('idea relax weird defense body bronze champion ancient vocal peanut similar dose grit company peasant gate sunset deal library act include penalty annual main', '');
    ...
    BITBOX.Mnemonic.mnemonicToSeedBuffer('bus aware census desk orphan zebra fashion host try muscle pig close jealous slice elegant prison reject ship great program trumpet syrup tray remove', '');
