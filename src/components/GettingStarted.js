      ...
      <div className="GettingStarted">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Create new $BCH apps in react, angular, nexjs and nodejs w/ <code>bitbox new PROJECT_NAME --scaffold react</code>. Create a blank app w/ <code>bitbox new PROJECT_NAME</code>. Test your code against a local blockchain or remote full running node. Dozens of utility methods to accelerate how quickly you can create your app.</p>
            ...
            <p><code>bitbox proxy</code> lets you <code>POST</code> to full BCH nodes w/out configuring CORS.</p>
          </div>
        </div>
