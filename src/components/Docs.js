      ...
      <div className="docs">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Download the <a href='https://github.com/bigearth/bitbox-electron/releases/download/0.1.3/BITBOX-0.1.3.dmg'>app for MacOS</a>. You can verify the files haven&rsquo;t been tampered w/ by downloading them and running</p>
