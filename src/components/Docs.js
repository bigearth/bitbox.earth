      ...
      <div className="docs">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>You can verify the files haven&rsquo;t been tampered w/ by downloading them and running <code>openssl sha -sha256 path/to/BITBOX.major.minor.path.dmg</code>. Verify the output matches the latest BITBOX release&rsquo;s <a href='https://github.com/bigearth/keys-n-hashes'>checksum</a>.
