      ...
      <div className="GettingStarted">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Creating paper wallets is as easy as <code>bitbox paper</code>. Set encoding to legacy or cashaddr. See the mnemonic and derivation path.</p>
