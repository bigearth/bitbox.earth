        ...
        <div className="pure-g">
          <div className="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-5 docsMenu">
            <ul>
              ...
              <li>
                <Link to="/bitboxcli/block"><i className="fas fa-cube" /> Block</Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/bitboxcli/transaction"><i className="fas fa-exchange-alt" /> Transaction</Link>
              </li>
              <li>
                <Link to="/bitboxcli/transactionbuilder"><i className="fas fa-arrows-alt-v" /> Transaction Builder</Link>
              </li>
              <li>
          ...
          <div className="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-4-5 docsContent">
            ...
            <Route path="/bitboxcli/block" component={Block}/>
            ...
            <Route path="/bitboxcli/transaction" component={Transaction}/>
