      ...
      <div className="Installation">
        ...
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Download the <a href='https://github.com/bigearth/bitbox-electron/releases/download/0.3.1/BITBOX-0.3.1.dmg'>app for MacOS</a>. You can verify the files haven&rsquo;t been tampered w/ by downloading them and running:</p>
            <SyntaxHighlighter language='text' style={ocean}>{" openssl sha -sha256 path/to/BITBOX-0.3.1.dmg"}</SyntaxHighlighter>
